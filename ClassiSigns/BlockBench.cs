...
#pragma warning disable 0649
    public class BlockBench
    {
        ...
        public class JsonRoot
        {
            ...
            public NamedPart[] ToParts()
            {
                var parts = new List<NamedPart>();
            ...
            private NamedPart ToPart(Element e)
            {
                if (!e.visibility)
                {
                    return null;
                ...
                return new NamedPart() { Name = e.name, Part = part };
            }
        ...
        public static JsonRoot Parse(string json)
        {
            ...
            JsonRoot m = JsonConvert.DeserializeObject<JsonRoot>(json, new JsonSerializerSettings
            {
                Converters = new JsonConverter[] { new JsonRoot.JsonUuidOrGroup(), new Vec3F32Converter() }
            });
            return m;
        }
    } // class BlockBench
